    ...
    <div class="container" id="header">
        <div class="row">
            <div class="col s5 offset-s7">
                <a  href="" class="z-depth-0 waves-effect waves-light white lighten-5 btn orange-text text-darken-4" id="header-btn"><i class="tiny material-icons left">person_outline</i>Đăng Nhập</a>
                <a href="" class="z-depth-0 waves-effect waves-light white lighten-5 btn orange-text text-darken-4" id="header-btn"><i class="material-icons left">person_add</i>Đăng Ký</a>
    ...
    <div class="container" id="nav">
        <nav class="z-depth-0">
            <div class="nav-wrapper">
                <a href="" class="brand-logo"><i class="large material-icons">store</i>Sneaker Store</a>
